...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF00A693);
  late Color tertiary = const Color(0xFFFF7F00);
  late Color alternate = const Color(0xFFFFBF00);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F5F5);
  late Color accent1 = const Color(0xFFE60000);
  late Color accent2 = const Color(0xFFFF4D4D);
  late Color accent3 = const Color(0xFFFFCC00);
  late Color accent4 = const Color(0xFF282727);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0059B3);
  late Color secondary = const Color(0xFF007B66);
  late Color tertiary = const Color(0xFFFF7F00);
  late Color alternate = const Color(0xFF996100);
  ...
  late Color accent1 = const Color(0xFF990000);
  late Color accent2 = const Color(0xFFB30000);
  late Color accent3 = const Color(0xFF996100);
  late Color accent4 = const Color(0xFFD1D1D1);
  late Color success = const Color(0xFF008000);
  late Color warning = const Color(0xFFFF6600);
  late Color error = const Color(0xFF990000);
  late Color info = const Color(0xFF0066CC);
}
